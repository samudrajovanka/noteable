...
function AuthPage() {
  return (
    <div className="flex h-screen">
      <div className="w-2/5 bg-na-green rounded-r-3xl flex flex-col justify-center items-center gap-10">
        ...
        <div className="fixed w-60 h-60 top-0 left-0">
          <Image
        ...
        <div className="fixed w-80 h-80 -bottom-20 left-0">
          <Image
      ...
      <div className="w-3/5 my-10 flex justify-center">
